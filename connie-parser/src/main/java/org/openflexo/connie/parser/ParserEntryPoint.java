...
package org.openflexo.connie.parser;
 ...
 * @author sylvain
 */
public class ParserEntryPoint {
	/**
	 * This is the method to invoke to perform the parsing of a string. It returns concrete syntax tree.
	 * 
	 * @param anExpression
	 * @return
	 ...
	 */
	public static Start parse(String anExpression) throws ParseException {
		try {
