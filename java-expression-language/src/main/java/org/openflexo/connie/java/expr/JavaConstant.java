...
public abstract class JavaConstant<V> extends Constant<V> {
	...
	public static class CharConstant extends JavaConstant<Character> {
		private char value;
	...
	public static class StringConstant extends JavaConstant<String> {
	...
	public static class ObjectConstant extends JavaConstant<Object> {
	...
	public static class EnumConstant<E extends Enum<E>> extends JavaConstant<Enum<E>> {
