...
public class JavaBinaryOperatorExpression extends BinaryOperatorExpression {

	public JavaBinaryOperatorExpression(BinaryOperator operator, Expression leftArgument, Expression rightArgument) {
	...
	public Expression transform(ExpressionTransformer transformer) throws TransformException {
		...
		if (!transformedLeftArgument.equals(getLeftArgument()) || !transformedRightArgument.equals(getRightArgument())) {
			expression = new JavaBinaryOperatorExpression(getOperator(), transformedLeftArgument, transformedRightArgument);
		}
