 ...
 * 
 */
final public class JavaMultipleParametersBindingEvaluator extends MultipleParametersBindingEvaluator {

	private JavaMultipleParametersBindingEvaluator(Map<String, Object> objects, BindingFactory bindingFactory) {
	...
	/**
	 * Utility method used to instanciate a {@link JavaMultipleParametersBindingEvaluator} to compute a given expression expressed in CONNIE
