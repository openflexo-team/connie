...
public abstract class JavaBooleanBinaryOperator extends JavaBinaryOperator {
	...
	public static abstract class LogicalBinaryOperator extends JavaBooleanBinaryOperator {
		@Override
		public EvaluationType getEvaluationType(EvaluationType leftOperandType, EvaluationType rightOperandType)
				throws TypeMismatchException {
			if (leftOperandType.isBooleanOrLiteral() && rightOperandType.isBooleanOrLiteral()) {
	...
	public static abstract class ComparisonBinaryOperator extends JavaBooleanBinaryOperator {
		@Override
		public EvaluationType getEvaluationType(EvaluationType leftOperandType, EvaluationType rightOperandType)
				throws TypeMismatchException {
