...
/**
 * 
 * This interface defines additional methods to be defined by all XMLIndividual
 * that will be manipulated by the XMLSaxHandler
 * 
...
public interface IXMLIndividual<IC, AC extends IXMLAttribute> {
    ...
    public abstract List<IC> getChildren();
