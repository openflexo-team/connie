...
public class DELUnaryOperatorExpression extends UnaryOperatorExpression {

	public DELUnaryOperatorExpression(UnaryOperator operator, Expression argument) {
	...
	public Expression transform(ExpressionTransformer transformer) throws TransformException {
		...
		if (!transformedArgument.equals(getArgument())) {
			expression = new DELUnaryOperatorExpression(getOperator(), transformedArgument);
		}
