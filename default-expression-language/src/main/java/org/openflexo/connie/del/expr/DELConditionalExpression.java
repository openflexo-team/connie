...
public class DELConditionalExpression extends ConditionalExpression {

	public DELConditionalExpression(Expression condition, Expression thenExpression, Expression elseExpression) {
	...
	public Expression transform(ExpressionTransformer transformer) throws TransformException {
		...
		if (!transformedCondition.equals(getCondition()) || !transformedThenExpression.equals(getThenExpression())
			...
			expression = new DELConditionalExpression(transformedCondition, transformedThenExpression, transformedElseExpression);
		}
