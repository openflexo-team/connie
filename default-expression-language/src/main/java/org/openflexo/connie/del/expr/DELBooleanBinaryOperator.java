...
public abstract class DELBooleanBinaryOperator extends DELBinaryOperator {

	public static final DELBooleanBinaryOperator AND = new LogicalBinaryOperator() {
		@Override
	...
	public static final DELBooleanBinaryOperator OR = new LogicalBinaryOperator() {
		@Override
		public int getPriority() {
			return 7;
		}
	...
	public static final DELBooleanBinaryOperator EQUALS = new ComparisonBinaryOperator() {
		@Override
		public int getPriority() {
			return 5;
		}
		...
		public Constant<?> evaluate(Constant<?> leftArg, Constant<?> rightArg) throws TypeMismatchException {
			...
			if (leftArg instanceof DateConstant && rightArg instanceof DateConstant) {
				return ((DateConstant) leftArg).getDate().equals(((DateConstant) rightArg).getDate()) ? BooleanConstant.TRUE
						: BooleanConstant.FALSE;
			}
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((DurationConstant) leftArg).getDuration().equals(((DurationConstant) rightArg).getDuration()) ? BooleanConstant.TRUE
						: BooleanConstant.FALSE;
			}
	...
	public static final DELBooleanBinaryOperator NOT_EQUALS = new ComparisonBinaryOperator() {
		@Override
		public int getPriority() {
			return 5;
		}
	...
	public static final DELBooleanBinaryOperator LESS_THAN = new ComparisonBinaryOperator() {
		@Override
		public int getPriority() {
			return 5;
		}
		...
		public Constant<?> evaluate(Constant<?> leftArg, Constant<?> rightArg) throws TypeMismatchException, NullReferenceException {
			...
			if (leftArg instanceof DateConstant && rightArg instanceof DateConstant) {
				return ((DateConstant) leftArg).getDate().before(((DateConstant) rightArg).getDate()) ? BooleanConstant.TRUE
						: BooleanConstant.FALSE;
			}
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((DurationConstant) leftArg).getDuration().lessThan(((DurationConstant) rightArg).getDuration())
						? BooleanConstant.TRUE
						: BooleanConstant.FALSE;
			}
			// System.out.println("leftArg=" + leftArg + " of " + leftArg.getClass().getSimpleName() + " of " +
	...
	public static final DELBooleanBinaryOperator LESS_THAN_OR_EQUALS = new ComparisonBinaryOperator() {
		@Override
		public int getPriority() {
			return 5;
		}
		...
		public Constant<?> evaluate(Constant<?> leftArg, Constant<?> rightArg) throws TypeMismatchException, NullReferenceException {
			...
			if (leftArg instanceof DateConstant && rightArg instanceof DateConstant) {
				return ((DateConstant) leftArg).getDate().before(((DateConstant) rightArg).getDate())
						|| ((DateConstant) leftArg).getDate().equals(((DateConstant) rightArg).getDate()) ? BooleanConstant.TRUE
								: BooleanConstant.FALSE;
			}
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((DurationConstant) leftArg).getDuration().lessOrEqualsThan(((DurationConstant) rightArg).getDuration())
						? BooleanConstant.TRUE
						: BooleanConstant.FALSE;
			}
			throw new TypeMismatchException(this, leftArg.getEvaluationType(), rightArg.getEvaluationType(),
	...
	public static final DELBooleanBinaryOperator GREATER_THAN = new ComparisonBinaryOperator() {
		@Override
		public int getPriority() {
			return 5;
		}
		...
		public Constant<?> evaluate(Constant<?> leftArg, Constant<?> rightArg) throws TypeMismatchException, NullReferenceException {
			...
			if (leftArg instanceof DateConstant && rightArg instanceof DateConstant) {
				return ((DateConstant) leftArg).getDate().after(((DateConstant) rightArg).getDate()) ? BooleanConstant.TRUE
						: BooleanConstant.FALSE;
			}
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((DurationConstant) leftArg).getDuration().greaterThan(((DurationConstant) rightArg).getDuration())
						? BooleanConstant.TRUE
						: BooleanConstant.FALSE;
			}
	...
	public static final DELBooleanBinaryOperator GREATER_THAN_OR_EQUALS = new ComparisonBinaryOperator() {
		@Override
		public int getPriority() {
			return 5;
		}
		...
		public Constant<?> evaluate(Constant<?> leftArg, Constant<?> rightArg) throws TypeMismatchException, NullReferenceException {
			...
			if (leftArg instanceof DurationConstant && rightArg instanceof DurationConstant) {
				return ((DurationConstant) leftArg).getDuration().greaterOrEqualsThan(((DurationConstant) rightArg).getDuration())
						? BooleanConstant.TRUE
						: BooleanConstant.FALSE;
			}
			throw new TypeMismatchException(this, leftArg.getEvaluationType(), rightArg.getEvaluationType(),
	...
	public static abstract class LogicalBinaryOperator extends DELBooleanBinaryOperator {
		@Override
		public EvaluationType getEvaluationType(EvaluationType leftOperandType, EvaluationType rightOperandType)
				throws TypeMismatchException {
			if (leftOperandType.isBooleanOrLiteral() && rightOperandType.isBooleanOrLiteral()) {
	...
	public static abstract class ComparisonBinaryOperator extends DELBooleanBinaryOperator {
		@Override
		public EvaluationType getEvaluationType(EvaluationType leftOperandType, EvaluationType rightOperandType)
				throws TypeMismatchException {
