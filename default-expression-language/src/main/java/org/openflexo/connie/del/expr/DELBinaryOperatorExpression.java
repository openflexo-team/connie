...
public class DELBinaryOperatorExpression extends BinaryOperatorExpression {

	public DELBinaryOperatorExpression(BinaryOperator operator, Expression leftArgument, Expression rightArgument) {
	...
	public Expression transform(ExpressionTransformer transformer) throws TransformException {
		...
		if (!transformedLeftArgument.equals(getLeftArgument()) || !transformedRightArgument.equals(getRightArgument())) {
			expression = new DELBinaryOperatorExpression(getOperator(), transformedLeftArgument, transformedRightArgument);
		}
