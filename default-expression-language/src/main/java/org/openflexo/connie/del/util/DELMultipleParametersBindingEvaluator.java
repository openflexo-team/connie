 ...
 * 
 */
final public class DELMultipleParametersBindingEvaluator extends MultipleParametersBindingEvaluator {

	private DELMultipleParametersBindingEvaluator(Map<String, Object> objects, BindingFactory bindingFactory) {
	...
	/**
	 * Utility method used to instanciate a {@link DELMultipleParametersBindingEvaluator} to compute a given expression expressed in CONNIE
