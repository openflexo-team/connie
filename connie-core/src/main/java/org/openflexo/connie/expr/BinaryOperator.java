...
public abstract class BinaryOperator extends Operator {
	...
	public abstract Expression evaluate(Expression leftArg, Constant<?> rightArg) throws TypeMismatchException, NullReferenceException;

	public abstract Expression evaluate(Constant<?> leftArg, Expression rightArg) throws TypeMismatchException, NullReferenceException;
